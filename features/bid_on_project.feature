Feature: Place a bid
  ...
  Scenario: One Team Member Bid Conflict Same Project
    ...
    And if yes, the system edits bid associated with “Coca-Cola Project” for team “Monsters” to priority 2
  ...
  Scenario: One Team Member Bid Conflict Different Projects
    ...
    And team name “Monsters” and I have already placed a bid for “Coca-Cola Project” with priority 1
    When I place a bid with priority 1 for “Pepsi Project”
    Then The system asks me whether I would like to transfer over my priority 1 bid from “Coca-Cola Project” to “Pepsi Project” for team “Monsters”
    And if no, the system does nothing
  ...
  Scenario: Two Team Members Bid Conflict
    Given A project with name “Coca-Cola Project” and team name “Monsters” and team member “Felipe” and team member “David” and Felipe already placed bid on “Coca-Cola Project” with priority 1
    ...
    And if no, the system does nothing
    And if yes, the system records “Coca-Cola Project” with priority 2 for team “Monsters”
